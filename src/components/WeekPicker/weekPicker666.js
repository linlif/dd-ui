...
class WeekPicker extends Component {
    ...
    componentDidMount() {
        ...
        const mapWeeksOfyear = this.mapWeeksOfyear()
    ...
    // 对周进行格式化，方便渲染
    formatWeeksToRender = (weeksInYear) => {
        let arr = [], temp = []
    ...
    // 点击某一周
    handleWeekClicked = (rowNum, colNum) => (e) => {
...
export const WeekPickerCom = (props) => {
    return <WeekPicker {...props} />
}

export default WeekPickerCom;